...
python -m pip install --upgrade pip setuptools wheel   # 古いpipだと editable 不可
pip install -e ".[dev]"
...
# Web ダッシュボード(過去・現在・未来)
#   現在: 資産配分/口座別/ストレス/保有一覧、未来: 将来予測、過去現在: 保有・ウォッチ銘柄の値動き
TRADERAI_MONTHLY=53000 traderai serve   # http://127.0.0.1:8787(積立額を渡すと将来予測に反映)
